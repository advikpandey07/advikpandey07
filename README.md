...
Currently exploring Python-based database applications focusing on SQLite, MySQL, and automated data operations.
...
- [ ] Build and publish real-world Python applications
- [ ] Improve problem-solving with DSA
- [ ] Start backend development & REST APIs
- [ ] Train and integrate Machine Learning models
